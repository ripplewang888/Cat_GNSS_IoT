...
typedef struct {
  ...
  u8 minp;          /** number of min decimal*/
  u8 minp1;         /** .xx of minute - 0-100*/
  u8 minp2;         /** .00xx of minute - 0-100 */
  u8 minp3;         /** .0000xx of minute - 0-100 */ 
}nmea_loc_t;
...
/**
 * Horizontal Dilution of precision ( HDOP 0.5 - 99.9 meters)
 */
typedef struct{
  u8 integ;       /** HDOP integer value */ 
  u8 dec;       /** .xx decimal 0-100 printf as %02d*/
}data_hdop_t;
