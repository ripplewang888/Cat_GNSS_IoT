...
#include <stdint.h>
	...
	#define MQTT_CONF_USERNAME_LENGTH 128 // Recommended by MQTT Specification (12 + '\0')
#endif

#ifndef MQTT_CONF_PASSWORD_LENGTH
	#define MQTT_CONF_PASSWORD_LENGTH 64 // Recommended by MQTT Specification (12 + '\0')
#endif


#define MQTT_CONNECTED                0x00
#define MQTT_REFUSED_PROTO_VER        0x01
#define MQTT_REFUSED_ID_REJECT        0x02
#define MQTT_REFUSED_SRVC_UNAVAILABLE 0x03
#define MQTT_REFUSED_BAD_UID_PWD      0x04
#define MQTT_REFUSED_NOT_AUTHORIZED   0x05


#define MQTT_MSG_CONNECT       1<<4 // 0x10
#define MQTT_MSG_CONNACK       2<<4 // 0x20
#define MQTT_MSG_PUBLISH       3<<4 // 0x30
#define MQTT_MSG_PUBACK        4<<4 // 0x40
#define MQTT_MSG_PUBREC        5<<4 // 0x50
#define MQTT_MSG_PUBREL        6<<4 // 0x60
#define MQTT_MSG_PUBCOMP       7<<4 // 0x70
#define MQTT_MSG_SUBSCRIBE     8<<4 // 0x80
#define MQTT_MSG_SUBACK        9<<4 // 0x90
#define MQTT_MSG_UNSUBSCRIBE  10<<4 // 0xA0
#define MQTT_MSG_UNSUBACK     11<<4 // 0xB0
#define MQTT_MSG_PINGREQ      12<<4 // 0xC0
#define MQTT_MSG_PINGRESP     13<<4 // 0xD0
#define MQTT_MSG_DISCONNECT   14<<4 // 0xE0
 ...
 * @param topic The topic name.
 * @param msg The message.
 * @param msglen Binary length of the message
 * @param retain Enable or disable the Retain flag (values: 0 or 1).
 ...
 * @retval -1 On IO error.
 */
int mqtt_publish_with_qos(mqtt_broker_handle_t* broker, const char* topic, const void* msg, uint16_t msglen, uint8_t retain, uint8_t qos, uint16_t* message_id);
